...
import { Server } from '../Core/Service.js';
import Query from '../Core/Services/Server/Query.js';
...
class TestController extends Controller {
    ...
    users = [4,5];
    radio = 1;
    textarea = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa minima et voluptatum hic facere ullam!';
    options = [
        { id: 1, name: 'John', text: '---' },
        { id: 2, name: 'Katya' },
        { id: 3, name: 'Harry' },
...
*/
    ...
    click(ev) {
        ...
        //this.radio = this.radio == 1 ? 2 : this.radio == 2 ? 3 : 1;
        //this.textarea = this.textarea.substring(this.textarea.indexOf(' ')+1);
        //this.select.push(4,5);
        //this.users.push(1);
        //this.selectOne = 3;
        console.log(this);
        Server.delete('/test-500.php').send({a: 1, test: 'ttt', items: [1,'',3,{test: false, on: null, v: [{id:1}, true]}]}, Query.CONTENT_JSON)
            .then(r => {
                console.log(r);
            })
            .catch(e => {
